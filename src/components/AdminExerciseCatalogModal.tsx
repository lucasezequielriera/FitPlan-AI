...
export default function AdminExerciseCatalogModal({
  isOpen,
  onClose,
}: {
  isOpen: boolean;
  ...
  const [selectedMuscleKey, setSelectedMuscleKey] = useState<string | "all">("all");
      ...
      >
        <div className="flex items-center justify-between gap-3 px-5 py-4 border-b border-white/10">
          <div className="flex items-center gap-2">
            <FaDumbbell className="text-cyan-400 text-lg" />
            <div>
          ...
          <div className="rounded-lg border border-amber-500/25 bg-amber-500/5 p-4 space-y-3">
            ...
            {planIndexLoading ? (
              ...
              <>
                ...
                <div className="max-h-52 overflow-y-auto rounded-lg border border-white/10 bg-black/30 divide-y divide-white/5">
