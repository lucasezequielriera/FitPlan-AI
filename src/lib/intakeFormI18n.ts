...
const COPY_ES: IntakeFormCopy = {
  metaTitle: "Formulario de Inicio | FitPlan",
  metaDescription:
    "Formulario de inicio del seguimiento 1:1 de FitPlan: objetivo, nivel, lesiones y rutina, para diseñar tu plan de entrenamiento y nutrición.",
  ...
  sections: {
    ...
    s6intro: "Nada de responder «perfecto»: lo que hay que contar es cómo se come hoy, normalmente.",
  ...
  trainingDaysQuestion: "Días concretos de compromiso para entrenar (si los hay)",
  equipmentQuestion: "Equipamiento disponible (si aplica)",
};

const COPY_EN: IntakeFormCopy = {
  metaTitle: "Intake Form | FitPlan",
  metaDescription:
...
export function getFieldLabels(locale: IntakeFormLocale) {
  const es = {
    ...
    planLugar: "¿El plan es para casa, para gimnasio o para los dos?",
    materialCasa: "Para entrenar en casa: ¿qué material hay?",
    phMaterial: "E.g. dumbbells, bands, bench…",
    phDiasN: "E.g. 3",
    expEntreno: "Experiencia entrenando",
    minSesion: "Minutos disponibles por sesión",
    horasSentado: "Horas sentado al día (aprox.)",
    pasos: "Pasos diarios (si se sabe)",
    ...
    corazon: "¿Alguna enfermedad del corazón? ¿Cuál?",
    ...
    phHs: "E.g. 6.5",
    trabajoHoras: "Horas de trabajo al día *",
    phTrabajo: "E.g. 8 h, 10 h, part-time…",
    comidasHorarios: "¿Cuántas comidas al día y a qué horas? *",
    phComidas: "E.g. 4 meals · 8:00, 12:30, 5:00, 9:00 PM",
    apetito: "¿Cómo describirías tu apetito?",
    masHambre: "¿En qué momento del día aprieta más el hambre?",
    ...
    diaTipo: "Un día normal, de levantarse a acostarse: ¿qué se come y a qué horas? *",
    suplementos: "Suplementos: ¿cuáles y de qué marca?",
    quiereSup: "Sin suplementos ahora mismo: ¿habría interés en empezar con alguno?",
