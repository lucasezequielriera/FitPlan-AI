...
ESTILO VISUAL (esto describe SOLO la paleta y el ambiente de la producción, no es el nombre de la marca ni del video — el nombre de marca es únicamente "FitPlan", ver arriba): fondo oscuro tipo estudio, negro neutro sin tinte azulado (#08090c a #111315), acentos en el gradiente lima #cbff3d -> coral #ff5f45 -> magenta #ff3d81, con el lima como color de interacción dominante (barras de progreso, checkmarks, chips, subrayados). Motion graphics limpios (barras de progreso, checkmarks, mockups de pantalla de móvil, chips flotantes) integrados con las escenas reales. Vibe: premium y enérgico, pero que parezca contenido, no publicidad.
